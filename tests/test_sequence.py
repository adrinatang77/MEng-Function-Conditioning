...
def test_sequence_data():
    ...
    cfg["datasets"] = {
        "openprot.data.uniref.UnirefDataset": {
            "path": "/Users/asapp/Documents/PhD/openprot_test_data/uniref50.fasta",
            "index": "/Users/asapp/Documents/PhD/openprot_test_data/uniref50.index",
        }
    }
    cfg["tasks"] = {
        "openprot.tasks.seq_gen.SequenceGeneration": {
            "fraction": 1.0,
            "mask_rate": 0.15,
            "seed": 137,
            "datasets": {"UnirefDataset": {"fraction": 1.0, "start": 0, "seed": 137}},
        }
    }
    # print(cfg)
