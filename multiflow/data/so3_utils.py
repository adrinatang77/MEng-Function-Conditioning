...
def geodesic_t(t: float, mat: torch.Tensor, base_mat: torch.Tensor, rot_vf=None, mat_uncond = None, guidance_weight=None) -> torch.Tensor:
    """
    ...
    if mat_uncond is not None:
        rot_vf_uncond = calc_rot_vf(base_mat, mat_uncond)
        rot_vf = rot_vf * guidance_weight + rot_vf_uncond * (1 - guidance_weight)
