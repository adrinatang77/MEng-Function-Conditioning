...
parser.add_argument(
    "--pdb_path", type=str, default="/scratch/projects/cgai/openprot/data/pdb_npz/"
)
parser.add_argument("--cov-thresh", type=float, default=0.9)
parser.add_argument("--evalue-thresh", type=float, default=0.01)
parser.add_argument(
    "--db", type=str, default="/scratch/projects/cgai/openprot/data/afdb_rep_v4/"
)
parser.add_argument("--blacklist_out", type=str, default=None)
parser.add_argument(
    "--foldseek", type=str, default="/home1/10165/bjing/foldseek/bin/foldseek"
)
